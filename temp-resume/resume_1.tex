...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Platforms}{: Linux, Proxmox, Windows 10 (basics), MacOS (basics)} \\ 
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        \resumeItemListStart 
          ...
          \resumeItem{\normalsize{Sends images of utility meter to S3, uses Rekognition to read image data, and stores data in DynamoDB.}}
        \resumeItemListEnd
