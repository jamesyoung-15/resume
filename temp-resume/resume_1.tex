...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        \vspace{1pt}
        \resumeItemListStart 
          \resumeItem{\normalsize{Worked on a low-cost IoT serverless digital utility meter reader using an ESP32-Cam and integrated with S3, Rekognition, Lambda, and DynamoDB.}}
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \vspace{1pt}
      \resumeItemListStart 
        \resumeItem{\normalsize{Programmed Arduino libraries for reading water sensor data with ESP32 and sending sensor data to AWS IoT Core with MQTT.}}
...
\section{Projects}
    ...
    \resumeProjectHeading
        {\textbf{\href{https://github.com/jamesyoung-15/homeserver}{ {Home Lab}}} \emph{}}{}
        \resumeItemListStart
          \resumeItem{\normalsize{Built homelab running Proxmox for self-hosting services such as file, media, web servers using Linux containers and VMs.}}
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{\normalsize{An event-driven serverless application that blurs faces on an image using S3, SQS, Lambda, and Rekogntion.}} 
        \resumeItem{\normalsize{Application deployable with IaC using Terraform.}}
      \resumeItemListEnd
