...
\section{Education}
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Masters in Computer Science (Part Time)}{Sept. 2024 -- June 2026}
  \resumeSubHeadingListEnd
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Tools/Platforms}{: Git, Docker, Linux, AWS (EC2, S3, Lambda)} \\
     \textbf{Hardware}{: STM32, Raspberry PI, ESP32, Arduino} \\
     \textbf{Protocols}{: UART, SPI, I2C} \\
    }}
 \end{itemize}
...
\section{Projects}
    ...
    \resumeProjectHeading
    {\textbf{\href{https://airqualitydashboard.jyydev.xyz/}{ {IoT Air Quality Monitoring} \small{\faExternalLink*}}}    \emph{}}{}
    \resumeItemListStart
      \resumeItem{\normalsize{An IoT air quality monitoring system that uses STM32 to measure data from SGP30 and AM2320 sensors and uses ESP32 to send and store data in AWS DynamoDB.}} 
    \resumeItemListEnd
...
\section{Extracurricular Activities}
    \begin{itemize}[itemsep=-2pt, parsep=5pt] 
        \item  {HKUST Soccer Team \hfill Jan. 2021 - July 2024}
    \end{itemize}
