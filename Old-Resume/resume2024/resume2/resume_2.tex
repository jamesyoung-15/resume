...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     %  \textbf{Libraries/Frameworks}{: ReactJS, NodeJS} \\
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart 
        ...
        \resumeItem{\normalsize{Achieved 40\% decrease in power consumption by implementing light sleep intervals in ESP32 and switching from HTTP to MQTT protocol.}}
      \resumeItemListEnd
...
\section{Projects}
    ...
    \resumeProjectHeading
        ...
        \resumeItemListStart
          \resumeItem{\normalsize{An event-driven serverless application that allows users to upload images and blurs faces on the images. Front-end uses ReactJS and middleware uses Lambda functions in Python.}} 
