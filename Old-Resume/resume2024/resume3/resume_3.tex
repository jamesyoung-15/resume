...
\section{Skills}
 \begin{itemize}[leftmargin=0.05in, label={}]
    \small{\item{
     ...
     \textbf{Tools/Platforms}{: Linux, AWS, Kubernetes, Terraform, Ansible, Docker, Git} \\ 
...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        \vspace{1pt}
        \resumeItemListStart 
          \resumeItem{\normalsize{Architected a cheap IoT serverless digital utility meter reader using an ESP32-Cam and integrated with AWS services such as S3, Rekognition, DynamoDB.}}
        \resumeItemListEnd
