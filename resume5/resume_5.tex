...
\section{Projects}
    ...
    {\textbf{\href{https://github.com/jamesyoung-15/homeserver}{ {Home Server} \small{\faExternalLink*}}}    \emph{}}{}
      \resumeItemListStart
      \vspace{3pt}
        \resumeItem{\normalsize{Built home server running bare metal Ubuntu server to host services such as NextCloud with Docker.}}
        \resumeItem{\normalsize{Became familiar and comfortable around Linux and the command-line interface. Also learned and applied knowledge of networking concepts such as reverse proxies.}}      
      \resumeItemListEnd
