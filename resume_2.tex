...
\section{PERSONAL PROJECTS}
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          {\href{https://github.com/jamesyoung-15/esp32-dht11-server}{\textbf{\large{\underline{Home Server}}} \href{Project Link}{\raisebox{-0.1\height}\faExternalLink }} $|$ \large{{Linux, Bash}}}{}
          \resumeItemListStart
          \vspace{3pt}
            \resumeItem{\normalsize{Built home server running bare metal Ubuntu server to host services such as NextCloud with
            Docker.}}
            \resumeItem{\normalsize{Became familiar and comfortable around Linux and the command-line interface. Also learned and applied various networking concepts such as reverse proxies, vlans, etc.}}
          \resumeItemListEnd
