...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Programming Languages}{: Python, Javascript, C++, Bash} \\
     \textbf{Tools/Platforms}{: Linux (Debian-based Distros, Red Hat Distros), Git, Docker, Ansible} \\ 
     \textbf{Cloud}{: AWS (Lambda, EC2, S3, DynamoDB)} \\
     \textbf{Others}{: Networking Concepts (VLANs, VPN, DNS), PC Hardware Assembly} \\
    }}
 \end{itemize}
