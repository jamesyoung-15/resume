...
\section{Skills}
 \begin{itemize}[leftmargin=0.08in, label={}]
    \small{\item{
     \textbf{Technologies}{: Python, Typescript, Javascript, SQL, HTML/CSS} \\
...
\section{Experience}
  ...
  \resumeSubheading
    {Incoming Software Engineering Intern}{June 2025 -- August 2025}
    {Granite Telecommunications}{United States}
    \resumeItemListStart
      \resumeItem{Upcoming summer internship, project to be determined}
    \resumeItemListEnd
