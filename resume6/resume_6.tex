...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
      \textbf{Operating Systems}{: Linux (Debian-based Distros), Windows 10, Windows Server 2019} \\ 
      \textbf{Hypervisors}{: Proxmox, VMWare ESXi} \\ 
      \textbf{Programming/Scripting}{: Python, C++, Bash} \\
      \textbf{Others}{: PC Hardware Assembly, Basic Networking Concepts (DNS, VLANs, etc.), AWS (EC2, S3, Lambda)} \\
    }}
 \end{itemize}
...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
        {\href{https://github.com/jamesyoung-15/FallDetection}{{Software Developer Intern}}}{December 2023 -- Feburary 2024}
    ...
    \resumeSubheading
        {\href{https://github.com/jamesyoung-15/ESP32Cam-MeterReading}{{Electronic Engineering Intern }}}{August 2023}
    ...
    \resumeSubheading
      {\href{https://github.com/jamesyoung-15/Internship-GraphiteVentureLimited}{{IoT Intern}}}{December 2022 -- May 2023}
...
\section{Projects}
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{\normalsize{Built home server running Proxmox hypervisor for self-hosting services and applications such as Nextcloud using Linux containers and virtual machines.}}
        \resumeItem{\normalsize{Built servers using consumer PC hardware parts.}}
      \resumeItemListEnd
