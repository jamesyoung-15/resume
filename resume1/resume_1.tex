...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        \vspace{1pt}
        \resumeItemListStart 
          \resumeItem{\normalsize{Worked on a low-cost IoT serverless digital utility meter reader that ESP32-Cam and integrated with API Gateway, S3, Rekognition, Lambda, and DynamoDB.}}
        \resumeItemListEnd
...
\section{Projects}
    ...
    \resumeProjectHeading
        ...
        \resumeItemListStart
          \resumeItem{\normalsize{Built homelab running Proxmox using Linux containers and VMs for self-hosting services such as file/media servers, Github self-hosted runners, etc.}}
          \resumeItem{\normalsize{Applied various tools such as Docker for containerization, Grafana for monitoring, Terraform and Ansible for deploying and provisioning resources, etc.}}
        \resumeItemListEnd
