...
\section{Projects}
    \resumeSubHeadingListStart
      ...
      % % {\textbf{\href{}{ {IoT Sensor Dashboard} \small{\faExternalLink*}}} $|$ \emph{NodeJS, ReactJS}}{}
      % {\textbf{\href{}{ {IoT Sensor Dashboard} \small{\faExternalLink*}}}}{}
      % \resumeItemListStart
      %   \resumeItem{\normalsize{Created a full-stack dashboard that.}}
      %   \resumeItem{\normalsize{.}}
      % \resumeItemListEnd

      % \resumeProjectHeading
      % {\textbf{\href{}{ {Electronic Inventory Management} \small{\faExternalLink*}}}}{}
      % \resumeItemListStart
      %   \resumeItem{\normalsize{}} 
      %   \resumeItem{\normalsize{}}
      %   \resumeItem{\normalsize{}}
      ...
      % \resumeProjectHeading
      % {\textbf{\href{https://github.com/jamesyoung-15/Mini-Robot-Cleaner}{ {Mini Robot Cleaner} \small{\faExternalLink*}}}  $|$  \emph{C, STM32, Python}}{}
      % \resumeItemListStart
