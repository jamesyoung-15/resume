  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        \resumeItemListStart
            ...
            \resumeItem{\textbf{Relevant Coursework:} Cloud Computing and Big Data Systems, Deep Learning in Computer Vision, Object-Oriented Programming and Data Structures, Artificial Intelligence for Medical Image Analysis}
        \resumeItemListEnd
...
\section{Skills}
 \begin{itemize}[leftmargin=0.08in, label={}]
    \small{\item{
     \textbf{Technologies}{: Python, Javascript, C++, SQL (MySQL), HTML/CSS} \\
...
\section{Projects}
    \resumeSubHeadingListStart
        ...
        % Project 3
        % \resumeSubheading
        %     {\textbf{\href{https://github.com/jamesyoung-15/homelab}{STM32 Robot Cleaner}}}{\emph{\href{https://jyyhomelab.com}{jyyhomelab.com}}}
        %     {Linux, Docker, Ansible, Terraform}{}
        %     \resumeItemListStart
        %     \resumeItem{Built and managed a setup of servers and network equipment for experimenting, learning, and self-hosting services}
        %     \resumeItem{Utilized Proxmox for virtualization and OPNsense firewall for advanced network configurations (e.g., VLANs)}
...
\section{Extracurriculars}
  \resumeSubHeadingListStart
    ...
    \resumeProjectHeading
      {\textbf{NCAE Cyber Games}}{Janurary 2025 -- March 2025}
      \resumeItemListStart
        \resumeItem{Joined the NCAE cyber security competition to compete against other students in capture the flag competitions
        }
      \resumeItemListEnd
