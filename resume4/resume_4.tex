...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Platforms}{: Linux, Windows 10, Windows Server, Windows AD, MacOS, Proxmox, VMWare} \\ 
...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingNoSkill
        {{{Software Developer Intern $|$ Intelligent Design Technology}}}{December 2023 -- Feburary 2024}
        % {Python}{(Full Time)}
        % \vspace{1pt}
        \resumeItemListStart 
          \resumeItem{\normalsize{Developed a prototype for real-time human fall detection for a Raspberry PI based robot using only camera inputs in Python.}}
    ...
    \resumeSubheadingNoSkill
      {{{IoT Intern $|$ Graphite Venture Limited}}}{December 2022 -- May 2023}
      % {C++, ESP32, Arduino}{(Full and Part Time)}
      % \vspace{1pt}
      \resumeItemListStart 
        \resumeItem{\normalsize{Developed C++ Arduino libraries for reading water sensor data with ESP32 and sending sensor data to AWS IoT Core through MQTT.}}
